...
//   init(server) {
//    console.log("SocketManager initialized with server:", server); //it is printing
...
//       console.log('Socket authentication middleware triggered',socket); //it isn't printing why?
//       try {
