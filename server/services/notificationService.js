...
//  * @param {string} message - Notification content
//  * @param {string} type - Notification type (booking/payment/system/other)
//  * @param {string|null} relatedId - Related booking/payment ID
//  * @param {object} templateData - Optional extra data to populate HTML email
//  * @param {object} options - Optional flags:
//  *    - sendEmail: boolean (default true)
//  *    - saveToDb: boolean (default true)
//  * @returns {Promise<{dbNotification: object|null, emailSent: boolean}>}
//  */
// exports.sendNotification = async (
//   recipientId,
//   recipientType,
...
//   relatedId = null,
//   templateData = {},
//   options = { sendEmail: true, saveToDb: true }
// ) => {
//   try {
//     let dbNotification = null;
//     let emailSent = false;

//     // Save notification to DB if enabled
//     if (options.saveToDb) {
...
//     if (options.sendEmail && recipientId) {
//       const recipient = await mongoose
//         .model(recipientType)
//         .findById(recipientId)
//         .select("email");
...
// /**
//  * Generate booking email HTML based on recipient type and booking status
//  */
// function generateBookingEmailTemplate(recipientType, data) {
//   if (recipientType === "User") {
//     if (data.status === "confirmed") {
