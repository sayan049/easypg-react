  ...
  return (
    <div>
      <Helmet>
        ...
        <meta
          name="description"
          content="MessMate's PG management software helps owners automate bookings, payments, and operations. Manage 100+ rooms with real-time analytics and 24/7 support. Start free today!"
        />
        <meta
          name="keywords"
          content="PG management software, hostel management system, student accommodation platform, PG owner tools, room booking system"
        />
        <link rel="canonical" href="https://www.messmate.co.in/our-services" />

        {/* Open Graph */}
        <meta
          property="og:title"
          content="Complete PG/Mess Management Solution | MessMate"
        />
        <meta
          property="og:description"
          content="Automate PG operations with all-in-one management software - bookings, payments, analytics & more"
        />
        <meta
          property="og:image"
          ...
          >
            <div className="container mx-auto px-4 text-center">
              ...
              <div className="text-lg md:text-xl mb-8 max-w-2xl mx-auto">
                Start managing smarter with MessMate and transform your PG
                business today.
              </div>
              <button
