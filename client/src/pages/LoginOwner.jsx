...
const loginwithgoogleOwner = () => {
  ...
  const submitResetPassword = async () => {
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        setResetToken(null);
        navigate("/login/owner"); // Redirect to login page
      } else {
  ...
  return (
    <div>
      <Helmet>
        <html lang="en-IN" />
        <title>OwnerLogin | Messmate</title>

        {/* Basic Meta */}
        <meta
          name="description"
          content="Securely access your MessMate owner account. Log in to access your Messmate dashboard and manage bookings and profile. Official owner portal for MessMate PG/Mess owners."
        />
        <meta name="robots" content="noindex, nofollow" />
        <link rel="canonical" href="https://www.messmate.co.in/login/owner" />

        {/* Open Graph (for link sharing previews) */}
        <meta property="og:type" content="website" />
        <meta
          property="og:url"
          content="https://www.messmate.co.in/login/owner"
        />
        <meta property="og:title" content="Owner Login | Messmate" />
        <meta
          property="og:description"
          content="Log in to your MessMate account and manage bookings, profile, and more. Secure portal for PG/Mess owners."
        />
        <meta
          property="og:image"
        ...
        <div className="flex flex-col lg:flex-row h-screen bg-custom-gradient">
          ...
          <div className="flex-1 lg:w-8/12 flex items-center justify-center p-6 flex-col">
            <div className="w-full max-w-lg p-8">
              ...
              >
                <h1 id="loginHeading" className="sr-only">
                  PG Owner Login
                </h1>
