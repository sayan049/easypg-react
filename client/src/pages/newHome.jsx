...
function NewHomePage() {
  ...
  return (
    <div className="text-gray-800">
      ...
      <section
        id="home"
        className="  pt-28 lg:pl-24 lg:pr-24 md:pl-16 md:pr-16 sm:pl-4 sm:pr-4"
      >
          ...
          <div className="text-center md:text-left">
            ...
            <div className="relative max-w-lg mx-auto sm:mx-0 pl-[2rem] pr-[2rem]">
              <img
                ...
                alt="q"
                className="absolute h-[19px] top-[16px] left-[37px]"
              />
              <input
                type="text"
      ...
      <section
        id="about"
        className=" py-16 lg:pl-24 lg:pr-24 md:pl-16 md:pr-16 sm:pl-4 sm:pr-4"
      >
      ...
      <h1 className="text-center text-xl font-semibold text-teal-600 mb-4">
        Contact us
      </h1>
      <div
        id="contact"
