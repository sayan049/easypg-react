...
//                           exit={{ opacity: 0, y: 10 }}
//                           transition={{ duration: 0.2 }}
//                           className="absolute w-full mt-1 top-full bg-white shadow-xl rounded-lg overflow-hidden z-50"
//                         >
    ...
    <div className="font-sans bg-white">
          ...
          <div className="container mx-auto px-6 relative z-10">
            <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
              ...
              >
                ...
                <div className="mt-8 relative">
                  <div
                    className={`flex border-3 rounded-full border-white transition-all duration-300 ${isSearchFocused ? "ring-4 ring-white/30" : ""}`}
                  >
                    <div className="absolute left-4 top-4 text-gray-400">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
      ...
      <section className="py-20 bg-white" id="cities">
        <div className="container mx-auto px-6">
          ...
          <div className="grid gap-6 grid-cols-2 sm:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4">
            {[
              { name: "Kolkata", img: "assets/kolkata.png", coords: { lat: 22.5726, lng: 88.3639 }, properties: 263 },
              { name: "Bankura", img: "assets/bankura.png", coords: { lat: 23.2324, lng: 87.0712 }, properties: 263 },
              {
                name: "West Medinipur",
                img: "assets/westMed.png",
                coords: { lat: 22.4211, lng: 87.3216 },
              ...
              { name: "Jhargram", img: "assets/jhargram.png", coords: { lat: 22.4526, lng: 86.9946 }, properties: 263 },
              {
                name: "Bardhaman",
                img: "assets/bardhaman.png",
                coords: { lat: 23.2333, lng: 87.8667 },
              ...
              { name: "Kalyani", img: "assets/kalyani.png", coords: { lat: 22.9756, lng: 88.4345 }, properties: 263 },
              { name: "Durgapur", img: "assets/durgapur.png", coords: { lat: 23.5204, lng: 87.3119 }, properties: 263 },
              { name: "Asansole", img: "assets/asansole.png", coords: { lat: 23.6739, lng: 86.9524 }, properties: 263 },
              { name: "Bolpur", img: "assets/bolpur.png", coords: { lat: 23.6688, lng: 87.6836 }, properties: 263 },
            ].map((city, index) => (
              <motion.div
                key={index}
                whileHover={{ y: -10 }}
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-6">
          <motion.div
            ...
            className="text-center mb-12"
          >
            <h2 className="text-3xl font-bold text-gray-800 mb-4">Mess Recommendations Near You</h2>
            <div className="w-20 h-1 bg-[#2CA4B5] mx-auto"></div>
            <p className="mt-4 text-gray-600 max-w-2xl mx-auto">
              Discover top-rated mess accommodations close to your location for the best student living experience
            </p>
          </motion.div>
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <div className="mt-3 flex items-center">
                    ...
                    <div className="text-sm text-gray-700">₹{mess.pricePerMonth}/month</div>
                  </div>
            ...
            >
              ...
              <div className="bg-gray-50 p-6 rounded-xl shadow-sm">
                ...
                <ul className="space-y-6">
                  {[
                    { color: "bg-orange-500", text: "Download the app." },
                    { color: "bg-yellow-500", text: "Search for accommodation or services." },
                    { color: "bg-green-500", text: "Book, pay, and manage everything in one place." },
                  ].map((step, index) => (
                    <motion.li
                      key={index}
                      initial={{ opacity: 0, x: -20 }}
              ...
              <div className="bg-white border-l-4 border-[#2CA4B5] rounded-lg p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
                ...
                <div className="space-y-4">
                  {[
                    { label: "Email", value: "info@messmate.com" },
                    { label: "Phone", value: "+91-XXXXXXXXXX" },
                    { label: "Address", value: "MessMate Pvt. Ltd., Chaitali Ray, khabar kolkata" },
                  ].map((contact, index) => (
                    <div key={index} className="flex items-start">
                      <div className="bg-[#2CA4B5]/10 p-2 rounded-full mr-4">
                        <svg
