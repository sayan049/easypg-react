...
//             duration: 0.3,
//           }}
//           className={`absolute -top-4 -left-80 z-50 w-72 ${config.bgColor} ${config.borderColor} border-2 rounded-2xl shadow-2xl ${config.glowColor} backdrop-blur-sm`}
//           style={{
...
//                 >
//                   Complete your profile details to activate your mess listing and start receiving bookings.
//                 </motion.p>
...
//                     className="px-4 py-2 bg-gradient-to-r from-amber-500 to-orange-500 text-white text-xs font-semibold rounded-lg shadow-md hover:shadow-lg transition-all duration-200 hover:from-amber-600 hover:to-orange-600"
//                   >
//                     Update Now
//                   </motion.button>
...
//                     whileTap={{ scale: 0.95 }}
//                     onClick={onDismiss}
//                     className={`px-4 py-2 ${config.textColor} text-xs font-medium hover:bg-white/50 rounded-lg transition-all duration-200`}
//                   >
//                     Later
//                   </motion.button>
//                 </motion.div>
...
//                 initial={{ x: "-100%" }}
//                 animate={{ x: "100%" }}
//                 transition={{ duration: 1.5, delay: 0.5, repeat: Number.POSITIVE_INFINITY, repeatDelay: 1 }}
