...
//                   <div
//                     key={room.id}
//                     className={`border rounded-2xl p-4 space-y-2 hover:border-primarycolor ${selectedRoom === room.id ? primaryColor : 'border-gray-200'}`}
//                   >
        ...
        <div className="space-y-6">
          <div className="rounded-2xl shadow-md bg-white">
            <div className="p-4 space-y-4">
              ...
              <div className="text-lg font-bold text-right" style={{ color: primaryColor }}>
                Total: ₹1,05,000
              </div>
            </div>
          </div>
