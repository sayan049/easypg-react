  ...
  return (
    <div className="min-h-screen bg-gray-100 flex">
      ...
      >
        ...
        <button onClick={handleLogout} className="absolute bottom-18 md:bottom-14 flex items-center gap-3 px-4 py-2 rounded-md mt-10 text-red-600 hover:bg-red-100 transition">
