                ...
                <div className="relative">
                  ...
                  {!isEmailVerified ? (
                    <button
                      ...
                      className="px-4 py-2 absolute right-1  rounded-full bg-primary-default hover:bg-primary-dark text-white disabled:cursor-not-allowed disabled:opacity-75"
                    >
          ...
          <div className="mt-10 pt-6 border-t border-primary-light">
            ...
            <div className="flex justify-center">
              <button
                ...
                className={`px-6 sm:px-8 py-2.5 sm:py-3 rounded-2xl text-white font-medium w-full sm:w-3/4 md:w-1/2 flex items-center justify-center ${
