...
//       <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 bg-custom-gradient">
//         {/* Header */}
...
//             </button>
//             <div>
//               <h1 className="text-2xl font-bold text-teal-600">Owner Registration</h1>
//               <p className="text-gray-600">Create your PG/Mess owner account</p>
//             </div>
//           </div>
...
//                         alt="Profile"
//                         className="w-48 h-48 rounded-full object-cover mx-auto border-4 border-teal-500"
//                       />
...
//                     </div>
//                   ) : (
//                     <div className="w-48 h-48 rounded-full bg-teal-100 mx-auto flex items-center justify-center border-4 border-dashed border-teal-300 hover:border-teal-500 transition-colors">
//                       <div className="text-center">
//                         <Upload className="h-10 w-10 mx-auto text-teal-500" />
//                         <p className="mt-2 text-sm text-teal-700">Upload Photo</p>
//                       </div>
//                     </div>
//                   )}
//                 </div>
//               </label>
//               <p className="text-sm text-gray-500 text-center mt-2">Upload a clear photo of yourself</p>
//             </div>
//           </div>
...
//                     <div
//                       onClick={() => document.getElementById("fileInput").click()}
//                       className="w-full h-32 border-2 border-dashed border-gray-300 rounded-lg flex items-center justify-center cursor-pointer hover:border-teal-500 transition-colors"
//                     >
//                       <div className="text-center">
//                         <Plus className="h-6 w-6 mx-auto text-teal-500" />
//                         <p className="text-sm text-gray-500 mt-1">Add More</p>
//                       </div>
//                     </div>
//                   )}
//                 </div>
...
//                 className={`px-8 py-3 rounded-lg text-white font-medium w-full md:w-1/2 flex items-center justify-center ${
